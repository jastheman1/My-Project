		...
		function createObject(e){
			...
			for(var i of newData){
				if(i["Continent"] === e.target.value){
					...
					const text = e.target.value === "Europe" ? "European" : e.target.value+"n";
					document.querySelector(".chart-title").innerHTML = text+" Countries and Coffee in ml";
				}
			}
